...
CREATE TABLE `classifications` (
  ...
  `proposed_result` enum('First Class Honours (1st)','Upper Second Class (2:1)','Lower Second Class (2:2)','Third Class Honours','Fail','Not eligible for Honours') NOT NULL,
  `final_result` enum('First Class Honours (1st)','Upper Second Class (2:1)','Lower Second Class (2:2)','Third Class Honours','Fail','Not eligible for Honours','Pending') NOT NULL DEFAULT 'Pending',
